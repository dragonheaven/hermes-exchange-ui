export const TV_CONFIG = {
  ...
  overrides: {
    ...
    'paneProperties.background': '#050C14',
    'paneProperties.vertGridProperties.color': '#050C14',
    'paneProperties.horzGridProperties.color': '#050C14',
    'paneProperties.crossHairProperties.color': '#ffffff',
    'paneProperties.topMargin': 5,
    'paneProperties.bottomMargin': 5,
    'paneProperties.gridProperties.color': '#050C14',
    ...
    'mainSeriesProperties.candleStyle.borderColor': '#050C13',
    'mainSeriesProperties.candleStyle.borderUpColor': '#066b06',
    'mainSeriesProperties.candleStyle.borderDownColor': '#e01b1c',
    'mainSeriesProperties.candleStyle.wickUpColor': '#050C13',
    'mainSeriesProperties.candleStyle.wickDownColor': '#050C13',
